...
def rule_based_classifier(text: str, engine: Any) -> EnsembleMemberResult:
...
def ensemble_classify(
    *,
    ...
    if not config.enabled:
        ...
        metadata = {"member_rationales": {result.member: result.rationale}, "member_confidence": {result.member: result.confidence}}
